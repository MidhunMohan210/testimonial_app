        ...
        {sections.map((section) => {
          ...
          return (
            <button
              ...
              className="group rounded-xl border border-white/80 bg-white p-4 text-left shadow-[0_26px_80px_-50px_rgba(15,23,42,0.42)] ring-1 ring-slate-950/[0.04] transition hover:-translate-y-0.5 hover:border-slate-200 hover:shadow-[0_32px_90px_-50px_rgba(15,23,42,0.5)] sm:p-5"
            >
              <div className="flex items-start justify-between gap-4">
                <span
                  className={cn(
                    "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border shadow-[0_18px_34px_-24px_rgba(15,23,42,0.45)] sm:h-12 sm:w-12",
              ...
              <h3 className="mt-4 text-base font-semibold text-slate-950 sm:mt-5 sm:text-lg">{section.label}</h3>
