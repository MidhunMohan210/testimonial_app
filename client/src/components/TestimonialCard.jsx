        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="min-w-0 flex-1 space-y-5">
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 sm:p-5">
              ...
              <p className="line-clamp-4 max-w-3xl text-sm leading-6 text-slate-700 sm:text-[15px] sm:leading-7">
          ...
          {!isReadOnly ? (
            <div className="flex w-full flex-col gap-3 xl:w-[220px] xl:min-w-[220px] xl:shrink-0 xl:pl-4">
              ...
              {testimonial.status !== "hidden" && (
                <Button
                  variant="outline"
                  className="w-full justify-center border-slate-200 bg-white hover:bg-slate-50"
              ...
              {testimonial.status !== "pending" && (
                <Button
                  variant="ghost"
                  className="w-full justify-center text-slate-600 hover:bg-slate-100 hover:text-slate-950"
